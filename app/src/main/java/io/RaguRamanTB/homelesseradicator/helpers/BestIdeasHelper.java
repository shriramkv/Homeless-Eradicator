...
public class BestIdeasHelper extends AsyncTask<String, Void, String> {

    Context context;
    private ProgressDialog progressDialog;

    public  BestIdeasHelper(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... voids) {
        String type = voids[0];
        if (type.equals("GetBestIdeas")) {
            try {
                URL url = new URL(Utils.bestIdeas_url);
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String totals = title + " : " + "\n" + idea + "\n" + "By - " + ideaby;
                Utils.arrayList3.add(totals);
                Fragment fragment = new BestIdeasFragment();
